...
overall increasing total simulation time (nt * dt) lead to an increase in the pollutant over time and space. Decreasing the  number of discrete segments (m) lead to greater distance of the pollutant along the path. 
