...
authors: Elmera Azadpour, Ryan Munnikhuis, Nikole Vannest
---
...
Overall, increasing the total simulation time (nt * dt) lead to an increase in pollutant diffusion over time and space. Decreasing the number of discrete segments (m) lead to greater distance of pollutants along the path. 
